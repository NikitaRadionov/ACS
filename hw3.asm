.data
	tests_or_input: .asciz "¬ведите 0 чтобы запустить тесты, 1 чтобы запустить программу: "
	input_dividend: .asciz "¬ведите делимое: "
	input_divisor: .asciz "¬ведите делитель: "
	output_quotient: .asciz "„астное: "
	output_remainder: .asciz "ќстаток: "
	zero_division_error: .asciz "ќшибка: произошла попытка делени€ на ноль"
	endl: .asciz "\n"
	tests_sep:	.asciz "~~~~~\nTEST "
